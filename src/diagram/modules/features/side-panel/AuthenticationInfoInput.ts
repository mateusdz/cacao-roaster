...
export abstract class AuthenticationInfoInput extends ComplexInput {
  ...
  createTHead(): HTMLTableSectionElement {
    ...
    let propertyPanel = new PropertyPanel(this._playbookHandler, 'authentication-info', {}, dialog);
    propertyPanel.setIsAgentTarget(false);
    propertyPanel.setIsSubPanel(true);
    // Creates the "Ok" button to create the definition property and close the panel
    propertyPanel.addButton('OK', () => {
      ...
      propertyPanel.reloadClearedProperties('authentication-info');
